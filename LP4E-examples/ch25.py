...
I2 = C1()
I1.setname('bob')                # Sets I1.name to ëbobí
I2.setname('mel')                # Sets I2.name to ëmelí
print(I1.name)                   # Prints ëbobí
...
I1 = C1('bob')                   # Sets I1.name to ëbobí
I2 = C1('mel')                   # Sets I2.name to ëmelí
print(I1.name)                   # Prints ëbobí
